...
<table id="products-table">
        ...
        <input type="button" value ="Editar" class="product-edit" onclick="abrirModalEdit()"/>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <form id="formAgregarProducto" action="../config/DatosInventario.php" method="post">
            ...
            <input type="button" value="Borrar Campos" class="product-submit" onclick="borrarCampos()">
        </form>
    </div>
</div>
