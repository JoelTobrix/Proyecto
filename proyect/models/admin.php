...
<body>
    ...
    <form action="#" method="post">
        <input type="button" value="Info del codigo" class="login-submit" onclick="mostrarMensaje()" style= "padding: 8px 30px 8px 25px; background-image: url('/proyect/images/codeadmin.png'); background-size: 20px 20px; background-repeat: no-repeat; background-position: 5px center;"> 
        <script>  
