...
<div id="myModal" class="modal">
 ...
 <script>
    ...
    if (filaSeleccionada.length > 0) {
        ...
        $('#formEditarProducto input[name="CodigoBarras"]').val(codigoBarras);
        $('#formEditarProducto input[name="NombreProducto"]').val(nombreProducto);
        $('#formEditarProducto input[name="PrecioProducto"]').val(precioProducto);
        $('#formEditarProducto input[name="ExistenciaProducto"]').val(existenciaProducto);
    ...
    $.ajax({
        type: 'POST',
        url: 'URL_A_TU_SERVIDOR_PARA_EDITAR_PRODUCTO',
